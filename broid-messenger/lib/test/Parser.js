...
ava_1.default('Parse a null', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.parse(null);
    t.deepEqual(yield data, null);
}));
ava_1.default('Normalize a simple message', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.normalize(mMessage);
    t.deepEqual(yield data, broidMessageNorm);
}));
ava_1.default('Normalize a message with image', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.normalize(mMessageImage);
    t.deepEqual(yield data, broidMessageNormImage);
}));
ava_1.default('Normalize a message with link', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.normalize(mMessageLink);
    t.deepEqual(yield data, broidMessageNormLink);
}));
ava_1.default('Normalize a interactive message callback', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.normalize(mMessageInteractiveCallback);
    t.deepEqual(yield data, broidMessageNormInteraCallback);
}));
ava_1.default('Normalize a interactive message callback with title', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.normalize(mMessageInteractiveCallbackTitle);
    t.deepEqual(yield data, broidMessageNormInteraCallbackTitle);
}));
ava_1.default('Normalize a location message', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.normalize(mMessageLocation);
    t.deepEqual(yield data, broidMessageNormLocation);
}));
ava_1.default('Parse a simple message', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
ava_1.default('Parse a message with image', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const r = Object.assign({}, broidMessageNormImage[0]);
    r.authorInformation = author;
    const data = parser.parse(r);
    t.deepEqual(yield data, broidMessageImage);
}));
ava_1.default('Parse a message with link', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const r = Object.assign({}, broidMessageNormLink[0]);
    r.authorInformation = author;
    const data = parser.parse(r);
    t.deepEqual(yield data, broidMessageLink);
}));
ava_1.default('Parse a interactive message callback', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const r = Object.assign({}, broidMessageNormInteraCallback[0]);
    r.authorInformation = author;
    const data = parser.parse(r);
    t.deepEqual(yield data, broidMessageInteraCallback);
}));
ava_1.default('Parse a interactive message callback with title', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const r = Object.assign({}, broidMessageNormInteraCallbackTitle[0]);
    r.authorInformation = author;
    const data = parser.parse(r);
    t.deepEqual(yield data, broidMessageInteraCallbackTitle);
}));
ava_1.default('Parse a location message', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const r = Object.assign({}, broidMessageNormLocation[0]);
    r.authorInformation = author;
    const data = parser.parse(r);
    t.deepEqual(yield data, broidMessageLocation);
}));
ava_1.default('Validate a simple message', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.validate(broidMessage);
    t.deepEqual(yield data, broidMessage);
}));
ava_1.default('Validate a message with image', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.validate(broidMessageImage);
    t.deepEqual(yield data, broidMessageImage);
}));
ava_1.default('Validate a message with link', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.validate(broidMessageLink);
    t.deepEqual(yield data, broidMessageLink);
}));
ava_1.default('Validate a interactive message callback', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const data = parser.validate(broidMessageInteraCallback);
    t.deepEqual(yield data, broidMessageInteraCallback);
}));
ava_1.default('Validate a location message', (t) => __awaiter(void 0, void 0, void 0, function* () {
