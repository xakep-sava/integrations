...
export class Parser {
  ...
  public parse(event: any): Promise<IActivityStream> {
    ...
    activitystreams.actor = {
      ...
      name: concat([R.path(['from', 'first_name'], normalized), R.path(['from', 'last_name'], normalized)]),
      type: 'Person'
    }
    ...
    activitystreams.target = {
      ...
      name:
        R.path(['chat', 'title'], normalized) ||
        concat([R.path(['chat', 'first_name'], normalized), R.path(['chat', 'last_name'], normalized)]),
