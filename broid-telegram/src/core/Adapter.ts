...
export class Adapter {
  ...
  public listen(): Observable<object> {
    ...
    return Observable.merge(
      Observable.fromEvent(this.session, 'callback_query').map(R.assoc('_event', 'callback_query')),
      Observable.fromEvent(this.session, 'inline_query').map(R.assoc('_event', 'inline_query')),
      Observable.fromEvent(this.session, 'chosen_inline_result').map(R.assoc('_event', 'chosen_inline_result')),
      Observable.fromEvent(this.session, 'message').map(R.assoc('_event', 'message'))
    )
      .switchMap(value => {
